...
// Осуществляет проверку предъявленного пользовательского токена на корректность.
// Если токен правильный, то извлекает из него user_uuid и возвращает http handler с контекстом, внутри которого 
// содержится user_uuid
